...
import { X, Wifi, Cable, Radio, User, Zap, Pencil } from 'lucide-react';
          ...
          <div className="drawer-section">
            ...
            {editingName ? (
              ...
              <div className="drawer-value-row">
                ...
                <button className="btn-icon-sm" onClick={() => setEditingName(true)} title="Rename">
                  <Pencil size={16} />
                </button>
              </div>
            )}
                  ...
                  <div className="drawer-field">
                    ...
                    <span className="drawer-value">
                      {conn.score_bars != null && (
                        <span className="signal-bars signal-bars-spaced">
                          {[1,2,3,4,5].map(b => (
